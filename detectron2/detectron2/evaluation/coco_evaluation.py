...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _eval_predictions(self, tasks, predictions, img_ids=None):
        ...
        for task in sorted(tasks):
            ...
            #     )
            #     res = self._derive_coco_results(
            #         coco_eval, "segm_boundary", class_names=self._metadata.get("thing_classes")
            #     )
            #     self._results["segm_boundary"] = res
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        metrics = {
            ...
            "segm_boundary": ["AP", "AP50", "AP75", "APs", "APm", "APl"],
...
def _evaluate_predictions_on_coco(
    coco_gt, coco_results, iou_type, kpt_oks_sigmas=None, use_fast_impl=True, img_ids=None, use_boundary=False
):
    """
    ...
    #     coco_eval = COCOeval(coco_gt, coco_dt, iouType="boundary")
