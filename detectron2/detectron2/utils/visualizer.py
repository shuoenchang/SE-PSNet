...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        iou_scores = predictions.iou_scores if predictions.has("iou_scores") else None
        cont_scores = predictions.cont_scores if predictions.has("cont_scores") else None
    ...
    def draw_panoptic_seg_predictions(
        ...
        try:
            ...
            scores = None
        labels = _create_text_labels(category_ids, None, self.metadata.thing_classes)
